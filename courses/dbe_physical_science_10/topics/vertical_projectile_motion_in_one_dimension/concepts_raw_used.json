...
symmetry 
•	Know that projectiles can 
have their motion described 
by a single set of equations 
for the upward and 
downward motion
•	Use equations of motion 
to determine the position, 
velocity and displacement 
of a projectile at any given 
time
•	Draw position vs. time (x 
vs. t), velocity vs. time (v 
vs. t) and acceleration vs. 
time (a vs. t) graphs for 1D 
projectile motion 	Give equations for position 
